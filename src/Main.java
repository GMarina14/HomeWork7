public class Main
{
    ...
    public static void task3()
    {
        ...
        int birthRateInMln=17*1000;
        int mortalityRateInMln=8*1000;
        int year=1;

        while(year<=10)
        {
            population+=(birthRateInMln-mortalityRateInMln);
    ...
    public static void task4()
    {
        ...
        {
            savings*=rate;
            System.out.println("Month number "+(month+1)+", savings amount = "+savings+" rubles.");
            month++;
        }
    ...
    public static void task8()
    {
        ...
        {
            if(startingPeriod%periodicityOfComet==0 && startingPeriod<=currentYear)
            {
                System.out.println(startingPeriod+" year ");
            }
            else if(startingPeriod>currentYear && startingPeriod%periodicityOfComet==0)
            {
